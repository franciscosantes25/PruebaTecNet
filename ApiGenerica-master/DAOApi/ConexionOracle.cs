...
namespace DAOApi
{
    public class ConexionOracle
    {
        ...
        private readonly string ESQUEMA_DB = ConfigurationManager.AppSettings["Server=(FRANCISCO);Database=BdGeneric;Trusted_Connection=True;MultipleActiveResultSets=true;"];
